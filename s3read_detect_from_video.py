...
if __name__ == '__main__':
    ...
    p.add_argument('--s3_bucket_path', '-s3', type=str)
    ...
    if args.s3_bucket_path is null:
        print('Reading files locally...')
        ...
        print('Reading files remotely on S3...')
        s3_bucket = args.s3_bucket_path
